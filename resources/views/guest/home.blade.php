...
<nav>
        ...
        <ul>
            ...
            <li><a href="{{route('logout')}}"  id="logout-btn">Log out</a></li>
        </ul>
...
<div class="container">
    ...
    <section class="facility">
        ...
        <div class="booking-hotel">
            ...
            <div class="booking-wrapper-items">
                ...
                <br>
                <div class="booking">
                   <button class="btn-booking"><a href="#room">Pesan</a></button>
                </div>
    ...
    <!-- CLASS ROOM -->
    <h2 class="title-class-room" style="margin-top:80px;" id="room">Lihat Kamar</h2>
            ...
            <section class="text-about">
                ...
                <div class="advantages">
                    ...
                    <div class="advantage-items">
                        ...
                        <p class="advantage-desc">Cabang</p>
                    </div>
                    <div class="advantage-items">
