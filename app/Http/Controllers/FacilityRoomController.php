...
class FacilityRoomController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.facility-room.index',compact('facilityrooms'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('/admin/facility-room/edit',compact('facilityrooms'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        FacilityRoom::find($id)->update($request->all());
        return redirect('/admin/facility-room/');
    }
